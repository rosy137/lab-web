...
<html>
	...
	<body>
        ...
        <%--
            * <%@ iclude %> 지시문과 비슷하게 다른 JSP의 내용을 포함시킴.
            * jspf 확장자를 사용할 수 없고, jsp만 사용.
            * include 하는 JSP마다 각각의 Java 파일과 클래스들이 생성됨.
         --%>
		<h1>JSP Action Tag</h1>
        <%--
            JSP 액션 태그: 스크립트릿에서 사용되는 자바 코드들은 HTML 또는 XML 등에 사용되는 
            태그로 대체하기 위해서 정의된 태그.
         ...
         <p>
            c2: <jsp:getProperty property="id" name="c2"/>
            <br />
