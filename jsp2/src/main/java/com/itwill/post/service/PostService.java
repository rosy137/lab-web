...
// Repository 계층의 메서드들을 사용해서 서비스를 만들어냄.
public class PostService {
    ...
    public Post read(long id) {
        log.info("read(), id");
        return postDao.detailSelect(id);
    }
    ...
    public List<Post> read(String keyword, String value) {
        
        log.info("search()", keyword, value);
        
        return postDao.search(keyword, value);
    }
